...
public class Board {
	...
	public void move(String nextMove) {
		...
		if(board[j][i].getType().equals("org.src.pieces.KING")){
			switch (nextMove) {
				case "e1g1": 
					board[1][6] = board[1][8];
					board[1][8] = null;
		...
		if (board[j][i].getType().equals("org.src.pieces.PAWN") && i != k && board[p][k] == null){
			board[j][k] = null;
		}

		if (board[j][i].getType().equals("org.src.pieces.PAWN") || board[j][i].getType().equals("org.src.pieces.KING")) {
			board[j][i].nrMoves++;
		}
	...
	public void movew(String nextMove, Piece[][] board1) {
		...
		if(board1[j][i].getType().equals("org.src.pieces.KING")) {
			switch (nextMove) {
				case "e1g1": 
		...
		if (board1[j][i].getType().equals("org.src.pieces.PAWN") || board1[j][i].getType().equals("org.src.pieces.KING")) {
			board1[j][i].nrMoves++;
		}
